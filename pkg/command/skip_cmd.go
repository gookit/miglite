...
func HandleSkip(opt SkipOption) error {
	...
	return r.SkipWithHooks(runtime.SkipOption{FileNames: opt.FileNames}, runtime.MigrationHooks{After: func(_, _ int, m *migration.Migration) { ccolor.Printf("- Migration <green>%s</> skipped\n", m.Version) }})
	/*
